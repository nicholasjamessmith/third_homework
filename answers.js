...
// Easy Going
////////////////////////////////
//Create a for loop that prints the numbers 1 through 20 when logged. Create a number variable equal to 1; make the variable less than or euqal to 20; write a funtion that continuously adds the variables within the set parameters.
for (let i = 1; i <= 20; i++) {
  console.log(i)
}
